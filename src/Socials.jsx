...
const ITEMS = [
  {
    id: "linkedin", label: "LINKEDIN", handle: "@ishan-rawat", href: "https://linkedin.com/in/ishan-rawat-b429b34b", icon: "💼", barIcon: icon1, bars: 1, newBars: [], counts: ["6+YR"],
    links: ["linkedin.com/in/ishan-rawat-b429b34b"],
    stats: [
      { tag: "EXP", value: "6+",  color: "#0a66c2" },
      { tag: "PRD", value: "007", color: "#00b8a9" },
    ],
  },
  {
    id: "github", label: "GITHUB", handle: "@ishanrawat97", href: "https://github.com/ishanrawat97", icon: "🐙", barIcon: icon2, bars: 1, newBars: [], counts: ["Profile"],
    links: ["github.com/ishanrawat97"],
    stats: [
      { tag: "LNG", value: "004", color: "#6e5494" },
      { tag: "REP", value: "★",   color: "#f77737" },
    ],
  },
  {
    id: "email", label: "EMAIL", handle: "ishanrawat@hotmail.com", href: "mailto:ishanrawat@hotmail.com", icon: "✉️", barIcon: icon3, bars: 2, newBars: [], counts: ["Delhi NCR", "+91-966"],
    links: ["ishanrawat@hotmail.com", "+91-9660236998"],
    stats: [
      { tag: "LOC", value: "IND", color: "#00f2ea" },
      { tag: "CTY", value: "DEL", color: "#ff0050" },
    ],
  },
];
